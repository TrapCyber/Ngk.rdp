...
./ngrok/ngrok.exe authtoken $env:2YpjnV0MBSGrA970Jux0aShilp5_4hfyHpAmTqEAPVHqaPMHv
...
Set-LocalUser -Name "runneradmin" -Password (ConvertTo-SecureString -AsPlainText "$env:OhShitNotMe1111!" -Force)
Exit
